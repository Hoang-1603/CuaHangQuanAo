...
const ChangePasswordPage = ({ navigate }) => {
  ...
  // Dung ham render thay vi component con de tranh bi remount moi lan re-render
  const renderRow = (label, field, placeholder) => (
  ...
  return (
    <div style={{ maxWidth: 680, margin: '0 auto', padding: '40px 5% 80px', fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      {renderRow("Mật khẩu cũ:", "old", "Mật khẩu cũ")}
      {renderRow("Mật khẩu mới:", "new", "Mật khẩu mới")}
      {renderRow("Xác Mật khẩu :", "confirm", "Xác Mật khẩu")}
